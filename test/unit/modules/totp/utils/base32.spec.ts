...
import {
	base32Decode,
	base32Encode
} from '#/modules/totp/utils/base32';

describe('base32', () => {
	describe('base32Encode', () => {
		test.concurrent('should encode a Uint8Array to a base32 string', () => {
	...
	describe('base32Decode', () => {
		test.concurrent('should decode a base32 string to a Uint8Array', () => {
			const input = 'JBSWY3DP';
			const expected = new Uint8Array([0x48, 0x65, 0x6c, 0x6c, 0x6f]);
			expect(base32Decode(input)).toEqual(expected);
		});

		test.concurrent('should throw error for invalid base32 character', () => {
