...
import { buildDeleteSchema } from '#/modules/schema-builder/build-delete-schema';
...
describe.concurrent('buildDeleteSchema', () => {
	test('should create a schema with a good type', () => {
		const schema = buildDeleteSchema(sourceSchema);
