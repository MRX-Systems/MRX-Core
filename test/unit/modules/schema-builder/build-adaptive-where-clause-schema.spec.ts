...
import { buildAdaptiveWhereClauseSchema } from '#/modules/schema-builder/build-adaptive-where-clause-schema';

describe.concurrent('buildAdaptiveWhereClauseSchema', () => {
	describe.concurrent.each([
		...
		test(`should have a good type for ${typeName}`, () => {
			const adaptiveWhereClauseSchema = buildAdaptiveWhereClauseSchema(schema);
