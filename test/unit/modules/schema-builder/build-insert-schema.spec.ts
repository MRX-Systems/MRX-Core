...
import { buildInsertSchema } from '#/modules/schema-builder/build-insert-schema';
...
describe.concurrent('buildInsertSchema', () => {
	test('should create a schema with a good type', () => {
		const schema = buildInsertSchema(sourceSchema);
