...
describe('isDateString', () => {
	describe('Valid date strings', () => {
		test.concurrent('should return true for ISO 8601 date strings', () => {
		...
		test.concurrent('should return true for other valid date formats', () => {
	...
	describe('Invalid date strings', () => {
		test.concurrent('should return false for clearly invalid strings', () => {
			expect(isDateString('invalid-date')).toBe(false);
			expect(isDateString('not-a-date')).toBe(false);
			expect(isDateString('')).toBe(false);
		});

		test.concurrent('should return false for invalid date values', () => {
		...
		test.concurrent('should return false for non-string inputs', () => {
