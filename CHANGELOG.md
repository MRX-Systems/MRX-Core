...
## v2.3.3-canary-20250514-764de87

[compare changes](https://github.com/Andesite-Lab/Core/compare/v2.3.3-canary-20250514-ce5e64c...v2.3.3-canary-20250514-764de87)

### 🔧 Fixes

- **🔧:** [Remove t.ts] ([253a76bd](https://github.com/Andesite-Lab/Core/commit/253a76bd))

### 🧹 Refactors

- **🧹:** [remove unused color enum exports] ([9daea580](https://github.com/Andesite-Lab/Core/commit/9daea580))
- **🧹:** [Refactor file structure, export, comments] ([f7e58962](https://github.com/Andesite-Lab/Core/commit/f7e58962))

### 📖 Documentation

- **📖:** [enhance HTTP status code documentation and structure] ([c6e65b86](https://github.com/Andesite-Lab/Core/commit/c6e65b86))
- **📖:** [update WhereClause interface documentation] ([a8a40f58](https://github.com/Andesite-Lab/Core/commit/a8a40f58))
- **📖:** [enhance Transaction type documentation] ([bc19f4c8](https://github.com/Andesite-Lab/Core/commit/bc19f4c8))
- **📖:** [update async iterable interface documentation] ([f42d90b1](https://github.com/Andesite-Lab/Core/commit/f42d90b1))
- **📖:** [improve documentation for QueryOptionsExtendPagination] ([304258f5](https://github.com/Andesite-Lab/Core/commit/304258f5))
- **📖:** [clarify throwIfNoResult and transaction properties] ([3fa97eaa](https://github.com/Andesite-Lab/Core/commit/3fa97eaa))
- **📖:** [update OrderBy type documentation for clarity] ([4b6366e6](https://github.com/Andesite-Lab/Core/commit/4b6366e6))
- **📖:** [add remarks for MssqlEventLog interface clarity] ([84ffca77](https://github.com/Andesite-Lab/Core/commit/84ffca77))
- **📖:** [Add detailed documentation for plugins] ([f2019ea8](https://github.com/Andesite-Lab/Core/commit/f2019ea8))

### 📦 Build

- **📦:** [update @types/bun dependency version] ([94db9e9a](https://github.com/Andesite-Lab/Core/commit/94db9e9a))

### 🌊 Types

- **🌊:** [refine advanced search type definitions and examples] ([f1d9a5fb](https://github.com/Andesite-Lab/Core/commit/f1d9a5fb))
...
- **🦉:** V2.2.3-canary-20250424-9a05df46 ([2dce042a](https://github.com/Andesite-Lab/Core/commit/2dce042a))
...
[compare changes](https://github.com/Andesite-Lab/Core/compare/v1.43.2...v2.1.0)
...
- **📦:** [update dependencies in package.json] Updated various dependencies in package.json to their latest versions for improved stability and performance. - Updated @eslint/js from ^9.24.0 to ^9.25.1 - Updated @types/bun from ^1.2.9 to ^1.2.10 - Updated eslint from ^9.24.0 to ^9.25.1 - Updated tsc-alias from ^1.8.14 to ^1.8.15 - Updated typedoc from ^0.28.2 to ^0.28.3 - Updated typescript-eslint from ^8.29.1 to ^8.31.0 - Updated @basalt-lab/basalt-helper from ^1.13.0 to ^1.13.3 - Updated ioredis from ^5.6.0 to ^5.6.1 ([bd749218](https://github.com/Andesite-Lab/Core/commit/bd749218))
...
- **🦉:** V2.1.0-canary-20250317-d4670d75 ([c694df6f](https://github.com/Andesite-Lab/Core/commit/c694df6f))
- **🦉:** V2.1.0-canary-20250319-42563e32 ([5044766b](https://github.com/Andesite-Lab/Core/commit/5044766b))
- **🦉:** V2.1.0-canary-20250320-1ee10333 ([bc1b6e00](https://github.com/Andesite-Lab/Core/commit/bc1b6e00))
- **🦉:** V2.1.0-canary-20250324-f2b16212 ([e0373484](https://github.com/Andesite-Lab/Core/commit/e0373484))
- **🦉:** V2.1.0-canary-20250327-8f2cd369 ([cc11f083](https://github.com/Andesite-Lab/Core/commit/cc11f083))
...
- **🦉:** V2.1.0-canary-20250408-4bfc53ad ([a2432fce](https://github.com/Andesite-Lab/Core/commit/a2432fce))
- **🦉:** V2.1.0-canary-20250410-da98e5bc ([56a9d7f4](https://github.com/Andesite-Lab/Core/commit/56a9d7f4))
- **🦉:** V2.1.0-canary-20250411-298158c4 ([2236c6ef](https://github.com/Andesite-Lab/Core/commit/2236c6ef))
- **🦉:** V2.1.0-canary-20250414-31441dd1 ([fcde273e](https://github.com/Andesite-Lab/Core/commit/fcde273e))
- **🦉:** [remove outdated changelog entries] ([e63bc2a2](https://github.com/Andesite-Lab/Core/commit/e63bc2a2))
- **🦉:** V2.1.0-canary-20250422-ee82f114 ([d3b0a296](https://github.com/Andesite-Lab/Core/commit/d3b0a296))
...
- **🤖:** [compute latest stable tag before changelog generation] ([6320e221](https://github.com/Andesite-Lab/Core/commit/6320e221))
...
## v2.1.0-canary-20250422-ee82f114

[compare changes](https://github.com/Andesite-Lab/Core/compare/v2.1.0-canary-20250414-31441dd1...v2.1.0-canary-20250422-ee82f114)
