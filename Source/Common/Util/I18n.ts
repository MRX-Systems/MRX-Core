 ...
 * 
 * @throws {@link AndesiteError} - If i18n is already initialized. {@link CommonErrorKeys.UTIL_I18N_IS_ALREADY_INITIALIZED}
 */
async function initI18n(resources: Readonly<Resource>, fallbackLng: string = 'en'): Promise<void> {
    if (_i18n && _i18n.isInitialized) 
        throw new AndesiteError({
            messageKey: CommonErrorKeys.UTIL_I18N_IS_ALREADY_INITIALIZED
        });
 ...
 * 
 * @throws {@link AndesiteError} - If i18n is not initialized. {@link CommonErrorKeys.UTIL_I18N_NOT_INITIALIZED}
 */
function resetI18n(): void {
    if (!(_i18n && _i18n.isInitialized))
        throw new AndesiteError({
            messageKey: CommonErrorKeys.UTIL_I18N_NOT_INITIALIZED
        });
    _i18n = undefined;
}
